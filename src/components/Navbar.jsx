          ...
          <div className='flex flex-1 items-center justify-center md:items-stretch md:justify-start'>
            ...
            <div className='hidden md:ml-6 md:block'>
              <div className='flex space-x-2'>
                <Link
                  href='/'
                  className='text-white bg-slate-700 hover:bg-slate-500 transition rounded-md px-3 py-2'
                >
                  Home
                </Link>
                <Link
                  href='/properties'
                  className='text-white hover:bg-slate-500 transition rounded-md px-3 py-2'
                >
                  Properties
                </Link>
                <Link
